...
@Component({
  selector: 'app-fiche-bateau-choisit',
  templateUrl: './fiche-bateau-choisit.component.html',
  styleUrls: ['./fiche-bateau-choisit.component.css']
})
export class FicheBateauChoisitComponent implements OnInit {

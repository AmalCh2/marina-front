...
@Component({
  selector: 'app-fiche-bateau-modifier',
  templateUrl: './fiche-bateau-modifier.component.html',
  styleUrls: ['./fiche-bateau-modifier.component.css']
})

export class FicheBateauModifierComponent implements OnInit {

...
@Component({
  selector: 'app-fiche-reservation-modifier',
  templateUrl: './fiche-reservation-modifier.component.html',
  styleUrls: ['./fiche-reservation-modifier.component.css']
})
export class FicheReservationModifierComponent implements OnInit {

...
@Component({
  selector: 'app-afficher-tarif-forfait',
  templateUrl: './afficher-tarif-forfait.component.html',
  styleUrls: ['./afficher-tarif-forfait.component.css']
})
export class AfficherTarifForfaitComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //this.displayedtarifs = this.tarifs.slice(0, 9);
  }
  ...
  tarifs: any[] = [
    { num_tarif: 1, annee: 2024, type: ' typetarif', debut: '2024-05-10', fin: '2024-05-10', largeur: 15, longueur: '25' },
    { num_tarif: 2, annee: 2024, type: ' typetarif', debut: '2024-05-12', fin: '2024-05-12', largeur: 15, longueur: '25' },
    { num_tarif: 2, annee: 2024, type: ' typetarif', debut: '2024-05-12', fin: '2024-05-12', largeur: 15, longueur: '25' },
    { num_tarif: 2, annee: 2024, type: ' typetarif', debut: '2024-05-12', fin: '2024-05-12', largeur: 15, longueur: '25' },
    { num_tarif: 2, annee: 2024, type: ' typetarif', debut: '2024-05-12', fin: '2024-05-12', largeur: 15, longueur: '25' },
    { num_tarif: 2, annee: 2024, type: ' typetarif', debut: '2024-05-12', fin: '2024-05-12', largeur: 15, longueur: '25' },
